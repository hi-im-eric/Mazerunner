...
const INLINE_ASSETS = [
  ...
  { placeholder: '__INLINE_ASSET:FANTASY_SCENE_BANNER__', path: path.join(inlineAssetsDir, 'fantasy-scene-banner.jpg') },
  { placeholder: '__INLINE_ASSET:FANTASY_SIDEBAR_TEXTURE__', path: path.join(inlineAssetsDir, 'fantasy-sidebar-texture.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_KPI_TEXTURE__', path: path.join(inlineAssetsDir, 'fantasy-kpi-texture.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_CONTENT_TEXTURE__', path: path.join(inlineAssetsDir, 'fantasy-content-texture.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_TORCH__', path: path.join(inlineAssetsDir, 'fantasy-torch.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_EYES__', path: path.join(inlineAssetsDir, 'fantasy-eyes.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_LIBRARY__', path: path.join(inlineAssetsDir, 'fantasy-library.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_COMPASS__', path: path.join(inlineAssetsDir, 'fantasy-compass.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_SCROLL__', path: path.join(inlineAssetsDir, 'fantasy-scroll.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_MARKETPLACE__', path: path.join(inlineAssetsDir, 'fantasy-marketplace.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_GOBLIN_SCRIBE__', path: path.join(inlineAssetsDir, 'fantasy-goblin-scribe.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_POTIONS__', path: path.join(inlineAssetsDir, 'fantasy-potions.png') },
  { placeholder: '__INLINE_ASSET:FANTASY_GOBLIN_POPOUT__', path: path.join(inlineAssetsDir, 'fantasy-goblin-popout.png') },
